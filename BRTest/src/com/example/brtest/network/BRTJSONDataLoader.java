...
/**
 * This class is an AsyncTask class that loads a list of stores from the
 * internal storage or net
 * 
 * @author Ehsan Barekati
 * 
 */
public class BRTJSONDataLoader extends
		AsyncTask<String, Void, ArrayList<BRTStore>> {
